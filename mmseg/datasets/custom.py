...
class CustomDataset_cityscape_clips(Dataset):
    ...
    def load_annotations2(self, img_dir, img_suffix, ann_dir, seg_map_suffix,
        ...
        #     path_list.append(img_infos[i]['filename'])

        # with open("/root/workspace/XU/MED_data/cityspace/val_list_mrcfa.txt",'w') as f:
...
class CustomDataset_video2(Dataset):
    ...
    def __init__(self,
        ...
        self.flip_video=True
        print("flip_video",self.flip_video)
        print("videos",len(self.videolists))
