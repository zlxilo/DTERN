...
class EMCAD(nn.Module):
    def __init__(self, channels=[512,320,128,64], kernel_sizes=[1,3,5], expansion_factor=6, dw_parallel=True, add=True, lgag_ks=3, activation='relu6',layer=4):
...
# decoder = EMCAD(channels=[256,256,256,256], kernel_sizes=[1,3,5], expansion_factor=2, dw_parallel=True, add=True, lgag_ks=3, activation="relu6")
# x4 = torch.randn(2, 256, 64, 64)
# x3 = torch.randn(2, 256, 128, 128)
# x2 = torch.randn(2, 256, 256, 256)
# x1 = torch.randn(2, 256, 512, 512)
# dec_out = decoder(x4, [x3, x2, x1])
# print(dec_out[0].shape, dec_out[1].shape, dec_out[2].shape, dec_out[3].shape)
